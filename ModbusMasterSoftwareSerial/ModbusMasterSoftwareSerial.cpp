...
@ingroup setup
*/
ModbusMasterSoftwareSerial::ModbusMasterSoftwareSerial(void)
{
  _u8SerialPort = 0;
  _u8MBSlave = 1;
}
...
@ingroup setup
*/
ModbusMasterSoftwareSerial::ModbusMasterSoftwareSerial(uint8_t u8MBSlave)
{
  _u8SerialPort = 0;
...
@ingroup setup
*/
ModbusMasterSoftwareSerial::ModbusMasterSoftwareSerial(uint8_t u8SerialPort, uint8_t u8MBSlave)
{
...
@ingroup setup
*/
void ModbusMasterSoftwareSerial::begin(void)
{
  begin(19200);
}
...
@ingroup setup
*/
void ModbusMasterSoftwareSerial::begin(uint16_t u16BaudRate)
{
...
void ModbusMasterSoftwareSerial::beginTransmission(uint16_t u16Address)
{
...
uint8_t ModbusMasterSoftwareSerial::requestFrom(uint16_t address, uint16_t quantity)
{
  uint8_t read;
...
void ModbusMasterSoftwareSerial::sendBit(bool data)
{
...
void ModbusMasterSoftwareSerial::send(uint16_t data)
{
...
void ModbusMasterSoftwareSerial::send(uint32_t data)
{
  send(lowWord(data));
  send(highWord(data));
}
...
void ModbusMasterSoftwareSerial::send(uint8_t data)
{
  send(word(data));
}

uint8_t ModbusMasterSoftwareSerial::available(void)
{
  return _u8ResponseBufferLength - _u8ResponseBufferIndex;
}


uint16_t ModbusMasterSoftwareSerial::receive(void)
{
...
*/
void ModbusMasterSoftwareSerial::idle(void (*idle)())
{
  _idle = idle;
}
...
@ingroup buffer
*/
uint16_t ModbusMasterSoftwareSerial::getResponseBuffer(uint8_t u8Index)
{
...
@ingroup buffer
*/
void ModbusMasterSoftwareSerial::clearResponseBuffer()
{
  uint8_t i;
...
@ingroup buffer
*/
uint8_t ModbusMasterSoftwareSerial::setTransmitBuffer(uint8_t u8Index, uint16_t u16Value)
{
  if (u8Index < ku8MaxBufferSize)
  {
...
@ingroup buffer
*/
void ModbusMasterSoftwareSerial::clearTransmitBuffer()
{
  uint8_t i;
...
@ingroup discrete
*/
uint8_t ModbusMasterSoftwareSerial::readCoils(uint16_t u16ReadAddress, uint16_t u16BitQty)
{
...
@ingroup discrete
*/
uint8_t ModbusMasterSoftwareSerial::readDiscreteInputs(uint16_t u16ReadAddress,
  uint16_t u16BitQty)
{
  _u16ReadAddress = u16ReadAddress;
  _u16ReadQty = u16BitQty;
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::readHoldingRegisters(uint16_t u16ReadAddress,
  uint16_t u16ReadQty)
{
  _u16ReadAddress = u16ReadAddress;
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::readInputRegisters(uint16_t u16ReadAddress,
  uint8_t u16ReadQty)
{
  _u16ReadAddress = u16ReadAddress;
  _u16ReadQty = u16ReadQty;
...
@ingroup discrete
*/
uint8_t ModbusMasterSoftwareSerial::writeSingleCoil(uint16_t u16WriteAddress, uint8_t u8State)
{
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::writeSingleRegister(uint16_t u16WriteAddress,
...
@ingroup discrete
*/
uint8_t ModbusMasterSoftwareSerial::writeMultipleCoils(uint16_t u16WriteAddress,
  uint16_t u16BitQty)
{
  _u16WriteAddress = u16WriteAddress;
...
uint8_t ModbusMasterSoftwareSerial::writeMultipleCoils()
{
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::writeMultipleRegisters(uint16_t u16WriteAddress,
...
uint8_t ModbusMasterSoftwareSerial::writeMultipleRegisters()
{
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::maskWriteRegister(uint16_t u16WriteAddress,
...
@ingroup register
*/
uint8_t ModbusMasterSoftwareSerial::readWriteMultipleRegisters(uint16_t u16ReadAddress,
...
@return 0 on success; exception number on failure
*/
uint8_t ModbusMasterSoftwareSerial::ModbusMasterTransaction(uint8_t u8MBFunction)
{
